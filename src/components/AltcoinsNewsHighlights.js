  ...
  return (
    <Box d="flex" flexWrap="wrap" justifyContent="center" m="4">
      <NewsCard
        ...
        SushiSwap has an appealing revenue to price ratio.Third, the DeFi market, in general, is performing strongly with the total value locked(TVL) now surpassing $30 billion.If SUSHI nears UNI, then the price of SUSHI could reach around $40 to $60, considering that Uniswap is valued at around $6 billion "
